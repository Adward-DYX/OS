...
/*用于在list_tracersal函数中的回调函数，用于针对线程队列的处理*/
static bool elem2thread_info(struct list_elem* pelem, int arg UNUSED){
   ...
   return false;  //此处返回false是为了迎合主调函数list_traversal只有回调函数返回false时，才会继续调用此函数
}
...
/*根据pid找到pcb，若找到则返回该pcb，否则返回NULL*/

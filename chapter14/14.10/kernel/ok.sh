gcc-4.4  -I ../lib/kernel/ -I ../lib/ -c -fno-builtin -m32 -o ../build/timer.o ../device/timer.c
...
gcc-4.4  -I ../lib/kernel/ -I ../lib/ -I ../kernel/ -I ../device/ -c -fno-builtin -m32 -o ../build/init.o init.c
...
###
 ...
 # @LastEditTime: 2024-04-07 16:05:53
